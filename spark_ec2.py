...
DEFAULT_SPARK_EC2_GITHUB_REPO = "https://github.com/jaymaity/spark-ec2"
DEFAULT_SPARK_EC2_BRANCH = "testnodep"
...
def launch_cluster(conn, opts, cluster_name):
    ...
    try:
        image = conn.get_all_images(image_ids=["ami-5bc1c64d"])[0]
        master_image = conn.get_all_images(image_ids=["ami-5bc1c64d"])[0]
    except:
...
def setup_cluster(conn, master_nodes, slave_nodes, opts, deploy_ssh_key):
    ...
    modules = ['spark', 'spark-standalone', 'task']
